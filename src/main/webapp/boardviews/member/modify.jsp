	...
	<section class="section">
		<div class="row">
			<div class="col-lg-12">
				...
				<form method="post" action="/member/modify" id="memberFrm">
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10 input-group">
									<input type="text" name="user_id" id="user_id" value="${vo.user_id}" class="form-control" readonly>
								</div>
							</div>
							<div class="row mb-3">
						...
						<div class="card-footer">
							<div class="d-flex justify-content-center">
								<a href="/member/list?page=${page}&search_key=${search_key}" class="btn btn-sm btn-outline-secondary ms-1">목록</a>
